...
export function buildTeammateGuide(
  ...
  return [
    ...
    ...(helperAvailable ? [
      ...
      'The preloaded teammate-guide is itself your shared baseline Skill. When asked which Skills or capabilities you have, identify this shared Skill, query `list_teammate_skills` for personal Skills, and distinguish those from optional external references returned by `get_teammate_state`. Empty references or an empty personal shelf never mean that you lack the shared teammate Skill or its operating procedures.',
